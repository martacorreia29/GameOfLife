...
generateMiddle rowTop row rowBottom =
		...
		let numNeighborsMainList = countRowNeighborsWithoutSelf Nil row False in
					...
					Tile currentIndex currentState currentNext ->
						case currentNext of {
							...
							Tile rightIndex rightState rightNext ->
								...
								then
										if currentState && countSelf
										then Number 2 countRowNeighbors current currentNext (index + 1)
										else Number 1 countRowNeighbors current currentNext (index + 1)
								else Number 0 countRowNeighbors current currentNext (index + 1)
						}
				},
					...
					Tile currentIndex currentState currentNext ->
						case next of {
							...
							then
								...
								then
									if currentState && countSelf
									then Number 3 countRowNeighbors current currentNext (index + 1)
									else Number 2 countRowNeighbors current currentNext (index + 1)
								else Number 1 countRowNeighbors current currentNext (index + 1)
							else Number 0 countRowNeighbors current currentNext (index + 1)
						}
				}
			...
			Tile index state next ->
					case numNeighborsList of{
						...
						Number numNeighbors xs ->
								let newState = applyGoLRules numberOfNeighbors state in
